...
void Dictionary_TestAll(void){
	...
	test("Dict_SizeIsNegativeValue_ReturnsNull", Dict_SizeIsNegativeValue_ReturnsNull, width);
	test("Dict_SizeIsZero_ReturnsNull", Dict_SizeIsZero_ReturnsNull, width);
	test("Dict_SizeIsPositiveValue_ReturnsDictionary", Dict_SizeIsPositiveValue_ReturnsDictionary, width);
	
	test("DelDict_DictIsNUll_ShouldDoNothing", DelDict_DictIsNUll_ShouldDoNothing, width);
	test("DelDict_DictIsNotNull_ShouldFreeAllStructures", DelDict_DictIsNotNull_ShouldFreeAllStructures, width);
	// test(,, width);
}
